...
const messages = {
  de: {
    ...
    proceedToYesNo:        'Weiter zu Ja oder Nein',
    yesNoQuestions:        'Ja oder Nein?',
    proceedToDemographics: 'Weiter zur Demografie',
    demographics:          'Demografie',
    proceedToReflection:   'Weiter zur Reflexion',
  ...
  en: {
    ...
    proceedToYesNo:        'Proceed to Yes or No',
    yesNoQuestions:        'Yes or No?',
    proceedToDemographics: 'Proceed to Demographics',
